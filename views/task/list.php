        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted">Something short and leading about the collection below—its contents, the
                    ...
                    entirely.</p>
                <p>
                    <a href="/task/createForm" class="btn btn-primary my-2">Добавить запись</a>
                </p>
            </div>
        </section>
                    ...
                    <?php foreach ($tasks as $task): ?>
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                <img class="card-img-top" src="<?='http://'.$_SERVER['HTTP_HOST'].'/'.$task['image'] ?>">
                                <div class="card-body">
